...
class _paymentState extends State<payment> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      key: _scaffoldKey,
      appBar: new AppBar(title: const Text(appName),backgroundColor: AppColors.primary,),
      body: new Container(
        ...
        child: new Form(
          ...
          child: new SingleChildScrollView(
            ...
            onSaved: (String value) => _address = value,
                ...
                _verticalSizeBox,
                Text('Card Information',style: TextStyle(fontSize: 25.0,fontWeight: FontWeight.bold)),
                new TextFormField(
                  decoration: const InputDecoration(
                    border: const UnderlineInputBorder(),
